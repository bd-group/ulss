...
public class SendCxData implements Runnable {
    ...
    public void init(String reg, int bs, LinkedBlockingQueue<GenericRecord> b) {
        ...
        this.schemanameInstance2metaq.put(region + "." + "t_cx_rz", Matcher.DBMeta.getMq(region, "t_cx_rz"));
        this.schemanameInstance2metaq.put(region + "." + "t_cx_rz_zt", Matcher.DBMeta.getMq(region, "t_cx_rz_zt"));
        this.schemanameInstance2metaq.put(region + "." + "t_cx_rz_mddz", Matcher.DBMeta.getMq(region, "t_cx_rz_mddz"));
        this.schemanameInstance2metaq.put(region + "." + "t_cx_rz_mtzx", Matcher.DBMeta.getMq(region, "t_cx_rz_mtzx"));
        this.schemanameInstance2metaq.put(region + "." + "t_cx_rz_tj", Matcher.DBMeta.getMq(region, "t_cx_rz_tj"));
    }
