...
import cn.ac.iie.ulss.match.sender.RocketMQProducer;
...
import cn.ac.iie.ulss.util.MiscTools;
...
public class Matcher {
    ...
    public static int generalSendBatchSizeNum = 1000;
    public static int hlwSendBatchSizeNum = 500;
    public static int cxSendBatchSizeNum = 50;
     ...
     * 
     */
    public static String producerGroup = "ulss-match";
    public static String namesrvAddr = "10.228.69.17:4181";
    public static String ip = MiscTools.getIpAddress();
    ...
    public static void main(String[] args) {
        ...
        Matcher.generalSendBatchSizeNum = cfg.getIntProperty("generalSendBatchSizeNum");
        Matcher.hlwSendBatchSizeNum = cfg.getIntProperty("hlwSendBatchSizeNum");
        Matcher.cxSendBatchSizeNum = cfg.getIntProperty("cxSendBatchSizeNum");
        ...
        /*
         */
        Matcher.producerGroup = "_" + cfg.getProperty("producerGroup");
        Matcher.namesrvAddr = cfg.getProperty("namesrvAddr");

        RocketMQProducer.init(Matcher.producerGroup, Matcher.namesrvAddr);
                ...
                if ("dx".equalsIgnoreCase(busiData)) {
                    ...
                    for (MatchControler mc : busiControlerMap.get(busiTypeInstance)) {
                        for (int i = 0; i < 2; i++) {
                            ...
                            ssd.init(s, Matcher.generalSendBatchSizeNum, mc.outBuf);
                    ...
                    for (MatchControler mc : busiControlerMap.get(busiTypeInstance)) {//实际只有一个MatchControler，最终的效果是只有一个发送线程5i///////////////////////////////////////////////////////////////、                                   '                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              /////                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     '''''''''                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
                        for (int i = 0; i < 12; i++) {
                            SendHlwData ssd = new SendHlwData(s, mc.resultSchemaName, Matcher.hlwSendBatchSizeNum, mc.outBuf);
                            Thread senThread = new Thread(ssd);
                            senThread.start();
                            try {
                                Thread.sleep(200);
