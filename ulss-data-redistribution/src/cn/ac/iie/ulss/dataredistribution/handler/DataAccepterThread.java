...
public class DataAccepterThread implements Runnable {
    ...
    public DataAccepterThread(String zkUrl, String topic, LinkedBlockingQueue bufferPool) {
        this.zkUrl = zkUrl;
        this.topic = topic;
    ...
    public void pullDataFromQ() {
        ...
        try {
            ...
            consumer.subscribe(topic, 5 * 1024 * 1024, new MessageListenerImpl(bufferPool));
    ...
    private class MessageListenerImpl implements MessageListener {
        ...
        public MessageListenerImpl(LinkedBlockingQueue bufferPool) {
            this.bufferPool = bufferPool;
        }
