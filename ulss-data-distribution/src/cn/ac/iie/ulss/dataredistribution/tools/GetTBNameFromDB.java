...
public class GetTBNameFromDB {
    ...
    public static void getTBNameFromDB() {
        ...
        String sql2 = "select data_transmitrule.region,data_transmitrule.topic,mq_table.table_name from data_transmitrule,mq_table where data_transmitrule.topic=mq_table.mq";
