...
public class LuceneWriterUtil {
    ...
    public static IndexWriter getSimpleLuceneWriter(String path, boolean isNew) {
        ...
        try {
            ...
            conf.setMaxBufferedDocs(GlobalParas.luceneBufferDocs);
            conf.setRAMBufferSizeMB(GlobalParas.luceneBufferRam);
            log.info("the lucene key paras are bufferram,bufferdocs:" + GlobalParas.luceneBufferRam + " " + GlobalParas.luceneBufferDocs);
    ...
    public static void main(String[] args) {
        try {
            ...
            IndexWriter FSWriter = LuceneWriterUtil.getSimpleLuceneWriter(".\\123456");
            FSWriter.commit();
            //FSWriter.close();
            //while (true) {
            //    Thread.sleep(5000);
