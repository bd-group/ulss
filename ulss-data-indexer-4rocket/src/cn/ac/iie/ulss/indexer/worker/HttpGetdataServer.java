...
public class HttpGetdataServer {
    ...
    public static void startup() throws Exception {
        ...
        server.start();
        server.setGracefulShutdown(60000);
    ...
    public static void init() throws Exception {
        ...
        ConfigureUtil conf = new ConfigureUtil(configFile);
        if (conf == null) {
        ...
        server.setThreadPool(new QueuedThreadPool(GlobalParas.httpServerPool));
        ...
        HttpDataHandler dataHandler = HttpDataHandler.geHttptDataHandler();
        if (dataHandler == null) {
    ...
    public static void main(String[] args) {
        GlobalParas.httpServerPool = Integer.parseInt(args[0]);
        try {
            init();
            startup();
        } catch (Exception ex) {
