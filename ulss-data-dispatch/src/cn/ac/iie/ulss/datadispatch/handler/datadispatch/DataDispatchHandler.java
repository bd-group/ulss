...
public class DataDispatchHandler extends AbstractHandler {
    ...
    public static DataDispatchHandler getDataDispatchHandler() {
        ...
        ResultSet rs = null;
        try {
            logger.info("getting data schema and corresponding message queue from metadb...");
            while (true) {
                try {
            ...
            logger.info("getting data schema and corresponding message queue from metadb is finished successfully");
            ...
            while (rs.next()) {
                ...
                logger.debug("schema " + schemaName + "'s content is:\n" + schemaContent);
