...
public class WriteRawfile implements Runnable {
    ...
    public WriteRawfile(IndexControler c, String path, String file_location, String devid, String schemaname, long fileid, ArrayBlockingQueue<GenericRecord> buf) {
        ...
        this.docsSchema = protocol.getType(Indexer.docs);
    ...
    public void run() {
        ...
        String pathInfo = "";
        File f = null;
        List<GenericRecord> innerBuffer = new ArrayList<GenericRecord>(Indexer.writeInnerpoolBatchDrainSize);
        ...
        while (true) {
            ...
            this.buffer.drainTo(innerBuffer, Indexer.writeInnerpoolBatchDrainSize);
            try {
                if (isNew) {
                    isNew = false;
