...
public class SimpleDaoImpl implements SimpleDao {
    ...
    private SimpleDaoImpl(String dbCluster) {
        jdbcTemplate = new JdbcTemplate();
        DataSource ds = DbUtilSpring.getDataSource(dbCluster);
        jdbcTemplate.setDataSource(ds);
    }

    public static SimpleDaoImpl getDaoInstance(String dbCluster) {
        if (sigleDaoInstance == null) {
            sigleDaoInstance = new SimpleDaoImpl(dbCluster);
        }
